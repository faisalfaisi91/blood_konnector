...
<body>
          ...
          <div class="col-12">
            <div class="hm1_content">
              <div class="video_play d-flex gap-2 align-items-center">
                <a href="https://youtu.be/" data-fancybox=""
              ...
              <a href="donate" class="explore_now red_btn">Explore Now</a>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row mb-5">
        <div class="col-12">
          <div class="common_title text-center">
            <p>How It Works</p>
            <h2>Step-by-Step Process to Find a Blood Donor</h2>
          </div>
        </div>
      </div>
      <div class="row">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-7 col-sm-9 col-12">
                    <div class="progress_content d-flex align-items-center gap-xl-5 gap-lg-5 gap-md-4 gap-sm-3 gap-3">
                      <div class="p_content_left">
                        <h5>Sign In</h5>
                        <p>
                          Create an account or log in to the platform to access blood donor services and begin the process.
                        </p>
                      </div>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-7 col-sm-9 col-12">
                    <div class="progress_content d-flex align-items-center gap-xl-5 gap-lg-5 gap-md-4 gap-sm-3 gap-3">
                      ...
                      <div class="p_content_left p_content_right">
                        <h5>Search for Donors</h5>
                        <p>
                          Use the search tool to find compatible blood donors based on your location and blood group.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <li>
                <div class="row">
                  <div class="col-xl-6 col-lg-6 col-md-7 col-sm-9 col-12">
                    <div class="progress_content d-flex align-items-center gap-xl-5 gap-lg-5 gap-md-4 gap-sm-3 gap-3">
                      <div class="p_content_left">
                        <h5>Connect With Donor</h5>
                        <p>
                          Reach out to the selected donor through the platform to confirm availability and arrange the details.
                        </p>
                      </div>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-7 col-sm-9 col-12">
                    <div class="progress_content d-flex align-items-center gap-xl-5 gap-lg-5 gap-md-4 gap-sm-3 gap-3">
                      ...
                      <div class="p_content_left p_content_right">
                        <h5>Get Donor</h5>
                        <p>
                          Successfully meet the donor, receive the blood donation, and complete the process to save a life.
                        </p>
                      </div>
                    </div>
                  </div>
  ...
  <!-- testimonial start -->
  <section class="testimonial ptb-115" style="padding: 0;">
    <div class="container">
      <div class="row ">
        <div class="col-12 mb-1">
          <div class="common_title text-center">
            <p style="margin-bottom: 10px;">testimonial</p>
      ...
      <div class="row">
        <div class="col-12 ">
          <div class="call_content text-center">
            ...
            <a href="#">
              <h2>Download: <span>APK Download for Android</span></h2>
            </a>
...
<script>
    ...
    // Download button click with SweetAlert
    $('.button.download').click(function(e) {
        e.preventDefault();
        Swal.fire({
            title: 'Login Required',
            text: 'Please log in to download the app.',
            icon: 'warning',
