          ...
          <div class="col-xl-7 col-lg-7 d-none d-xxl-block d-xl-block">
            <ul class="main_menu">
              <li class="position-relative dropdown">
                <a class="dropdown-toggle" href="#" id="companyMenu" role="button" data-bs-toggle="dropdown" aria-expanded="false" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();this.click();}">Company</a>
              ...
              <?php
                if (isset($_SESSION['user_id'])) {
                  ...
                  if ($hasRecipient || $hasDonor): ?>
                    <li class="position-relative dropdown">
                    <a class="dropdown-toggle" href="#" id="emergencyMenu" role="button" data-bs-toggle="dropdown" aria-expanded="false" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();this.click();}">Emergency</a>
