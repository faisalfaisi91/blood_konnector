-- =====================================================
-- Database Migration: Add City Column to emergency_requests
-- =====================================================
-- This migration adds a city column to emergency_requests table
...
-- Add city column to emergency_requests table if it doesn't exist
...
-- Add blood_type column to emergency_requests table if it doesn't exist
...
SET @sqlstmt_index := IF(@exist_index = 0, 
    'ALTER TABLE emergency_requests ADD INDEX idx_city (city)',
    'SELECT 1');
...
SET @sqlstmt_blood_index := IF(@exist_blood_index = 0, 
    'ALTER TABLE emergency_requests ADD INDEX idx_blood_type (blood_type)',
    'SELECT 1');
